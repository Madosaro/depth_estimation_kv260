...
class UNet(torch.nn.Module):
    def __init__(self):
        ...
        self.module_4 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/DoubleConv[inc]/Sequential[double_conv]/ReLU[5]/3536
        ...
        self.module_9 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Down[down1]/Sequential[maxpool_conv]/DoubleConv[1]/Sequential[double_conv]/ReLU[5]/3602
        ...
        self.module_14 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Down[down2]/Sequential[maxpool_conv]/DoubleConv[1]/Sequential[double_conv]/ReLU[5]/3668
        ...
        self.module_19 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Down[down3]/Sequential[maxpool_conv]/DoubleConv[1]/Sequential[double_conv]/ReLU[5]/3734
        ...
        self.module_24 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Down[down4]/Sequential[maxpool_conv]/DoubleConv[1]/Sequential[double_conv]/ReLU[5]/3800
        self.module_25 = py_nndct.nn.ConvTranspose2d(in_channels=384, out_channels=192, kernel_size=[2, 2], stride=[2, 2], padding=[0, 0], output_padding=[0, 0], groups=1, bias=True, dilation=[1, 1]) #UNet::UNet/Up[up4]/ConvTranspose2d[up]/3819
        ...
        self.module_30 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Up[up4]/DoubleConv[conv]/Sequential[double_conv]/ReLU[5]/3874
        self.module_31 = py_nndct.nn.ConvTranspose2d(in_channels=192, out_channels=96, kernel_size=[2, 2], stride=[2, 2], padding=[0, 0], output_padding=[0, 0], groups=1, bias=True, dilation=[1, 1]) #UNet::UNet/Up[up5]/ConvTranspose2d[up]/3893
        ...
        self.module_36 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Up[up5]/DoubleConv[conv]/Sequential[double_conv]/ReLU[5]/3948
        self.module_37 = py_nndct.nn.ConvTranspose2d(in_channels=96, out_channels=48, kernel_size=[2, 2], stride=[2, 2], padding=[0, 0], output_padding=[0, 0], groups=1, bias=True, dilation=[1, 1]) #UNet::UNet/Up[up6]/ConvTranspose2d[up]/3967
        ...
        self.module_42 = py_nndct.nn.ReLU(inplace=True) #UNet::UNet/Up[up6]/DoubleConv[conv]/Sequential[double_conv]/ReLU[5]/4022
        self.module_43 = py_nndct.nn.ConvTranspose2d(in_channels=48, out_channels=24, kernel_size=[2, 2], stride=[2, 2], padding=[0, 0], output_padding=[0, 0], groups=1, bias=True, dilation=[1, 1]) #UNet::UNet/Up[up7]/ConvTranspose2d[up]/4041
        ...
        self.module_49 = py_nndct.nn.Conv2d(in_channels=24, out_channels=1, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #UNet::UNet/OutConv[outc]/Conv2d[conv]/4115
